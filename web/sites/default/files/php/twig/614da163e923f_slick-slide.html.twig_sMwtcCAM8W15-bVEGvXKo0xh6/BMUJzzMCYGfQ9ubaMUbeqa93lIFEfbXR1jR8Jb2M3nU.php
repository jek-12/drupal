...
class __TwigTemplate_e8e0adb1bbd75ec7112166ca3e475b13cd05327d1896e159abbfd91879e2f055 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["delta"] ?? null), 22, $this->source)), 3 => ((twig_test_empty(twig_get_attribute($this->env, $this->source,         // line 23
($context["item"] ?? null), "slide", [], "any", false, false, true, 23))) ? ("slide--text") : ("")), 4 => ((twig_get_attribute($this->env, $this->source,         // line 24
($context["settings"] ?? null), "layout", [], "any", false, false, true, 24)) ? (("slide--caption--" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "layout", [], "any", false, false, true, 24), 24, $this->source)))) : ("")), 5 => ((twig_get_attribute($this->env, $this->source,         // line 25
...
";
  ...
  ";
            // line 51
            if (twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "grid", [], "any", false, false, true, 51))) {
                echo "<div";
