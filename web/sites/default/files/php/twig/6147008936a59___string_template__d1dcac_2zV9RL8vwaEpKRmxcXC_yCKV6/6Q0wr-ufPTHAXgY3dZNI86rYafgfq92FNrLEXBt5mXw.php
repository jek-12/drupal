...
class __TwigTemplate_ce9099e6d8bf69178abb06f421e9a03022c513a2faa8ea2510e5e64cd90a236a extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{# inline_template_start #}{% trans %}{{ date }} by {{ username }}{% endtrans %}{% if message %}<p class=\"revision-log\">{{ message }}</p>{% endif %}", "__string_template__d1dcac4d53475c967f915eaf29024c1f662d50857ebe0a311956741387a31e54", "");
    }
