...
class __TwigTemplate_c0d7fe8f38a19d6ba7ce4eeda52385fe5e9f7e121359897475a24a4733a60ba0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 34
        echo "  ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, true, 34), "uri", [], "any", false, false, true, 34), 34, $this->source));
        echo "
";
        // line 36
        echo "
  ...
  ";
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 48
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "nav navbar-nav"], "method", false, false, true, 48), 48, $this->source), "id"), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 50
